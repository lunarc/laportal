...
class ScriptTask(Tasks.BaseTask):
    def __init__(self):
...
class ScriptPlugin(Plugins.PluginBase):
    def onInit(self):
...
class ScriptPluginDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.createNewFileButton = wx.Button(self.inputFilePane, -1, "Create...")
        ...
        self.Bind(wx.EVT_BUTTON, self.onCreateFile, self.createNewFileButton)
    ...
    def __do_layout(self):
        ...
        sizer_9_copy.Add(self.createNewFileButton, 0, wx.ADJUST_MINSIZE, 0)
