...
class CertificateInfoWindow(wx.Frame):
    ...
    def __do_layout(self):
        ...
        sizer_24.Add(self.dnLabel, 0, wx.ADJUST_MINSIZE, 0)
        sizer_24.Add(self.dnText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        sizer_23.Add(sizer_24, 0, wx.ALL|wx.EXPAND, 4)
        sizer_26.Add(self.notBeforeLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_26.Add(self.notBeforeText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        sizer_23.Add(sizer_26, 0, wx.ALL|wx.EXPAND, 4)
        sizer_27.Add(self.notAfterLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_27.Add(self.notAfterText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        sizer_23.Add(sizer_27, 0, wx.ALL|wx.EXPAND, 4)
        self.certPane.SetSizer(sizer_23)
        sizer_24_copy.Add(self.proxyRemainingLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_24_copy.Add(self.proxyRemainingText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        sizer_23_copy.Add(sizer_24_copy, 0, wx.ALL|wx.EXPAND, 4)
        sizer_26_copy.Add(self.proxyNotBeforeLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_26_copy.Add(self.proxyNotBeforeText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        sizer_23_copy.Add(sizer_26_copy, 0, wx.ALL|wx.EXPAND, 4)
        sizer_27_copy.Add(self.proxyNotAfterLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_27_copy.Add(self.proxyNotAfterText, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 0)
        ...
        sizer_22.Add(self.closeButton, 0, wx.ADJUST_MINSIZE, 0)
    ...
    def setUserConfig(self, userConfig):
        ...
        proxyPath = str(self.__userConfig.ConfTree().Get("ProxyPath"))
        userCertPath = str(self.__userConfig.ConfTree().Get("CertificatePath"))
        userKeyPath = str(self.__userConfig.ConfTree().Get("KeyPath"))
