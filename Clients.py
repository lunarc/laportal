...
class ArcGuiConfig(object):
    ...
    def write(self):
        ...
        if self.brokerName!="":
            ...
            print "write: brokerName = ", self.brokerName
    ...
    def read(self):
        ...
        if self.keyPath == "":
            self.keyPath = os.path.expanduser("~/.globus/userkey.pem")
            self.userConfig.KeyPath(self.certificatePath)
        ...
        if parser.has_section("arcgui"):
            ...
            if parser.has_option("arcgui", "automaticupdate"):
                self.automaticStatusUpdate = parser.getboolean("arcgui", "automaticupdate")
            if parser.has_option("arcgui", "automaticupdateinterval"):
                self.automaticStatusUpdateInterval = int(parser.get("arcgui", "automaticupdateinterval"))
