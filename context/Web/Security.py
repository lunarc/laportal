...
class FieldValidationMixin:
        ...
        def rawString(self, inputString):
                return inputString
        ...
        def getRawString(self, request, fieldName):
                """Retrieve raw field without dangerous characters removed."""
                if request.hasValue(fieldName):
                        return request.field(fieldName)
                else:
                        return None
