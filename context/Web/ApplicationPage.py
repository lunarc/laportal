...
class ApplicationPage(DefaultPage):
	...
	def onInitMenu(self, menuBar, adapterName):
		...
		menuInformation = Web.Ui.menuFactory(self, "menuInformation", "Information", "")
				
		menuInformationDocs = Web.Ui.menuFactory(self, "menuInformationDocs", "Documentation", "")
		...
		menuInformationSoftware = Web.Ui.menuFactory(self, "menuInformationSoftware", "Software", "")
		...
		menuSession = Web.Ui.menuFactory(self, "menuSession", "Session", "")
