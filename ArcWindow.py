...
class GuiUserAuthentication(UserAuthentication):
    ...
    def onPassphrasePrompt(self, prompt=""):
        ...
        if proxyDialog.dialogResult:
            ...
            self.proxyType = proxyDialog.proxyLifetime
...
class ArcWindow(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        ARCGUI_NEW_DEFINITON_IMAGE = os.path.join(self.__applicationDir, "images/stock-new.png")
        ARCGUI_EDIT_DEFINITON_IMAGE = os.path.join(self.__applicationDir, "images/stock-edit.png")
        ARCGUI_SUBMIT_DEFINITION_IMAGE = os.path.join(self.__applicationDir, "images/stock-submit.png")
        ARCGUI_OPEN_RESULTS_IMAGE = os.path.join(self.__applicationDir, "images/open-results.png")
        ARCGUI_DELETE_DEFINITION_IMAGE = os.path.join(self.__applicationDir, "images/edit-delete.png")
        ARCGUI_VIEW_DESCRIPTION = os.path.join(self.__applicationDir, "images/preview-xrsl.png")
        ARCGUI_REFRESH_JOBS_IMAGE = os.path.join(self.__applicationDir, "images/refresh-jobstatus.png")
        ARCGUI_DOWNLOAD_JOB_IMAGE = os.path.join(self.__applicationDir, "images/download-job.png")
        ARCGUI_DOWNLOAD_ALL_IMAGE = os.path.join(self.__applicationDir, "images/download-all.png")
        ARCGUI_KILL_JOB_BUTTON = os.path.join(self.__applicationDir, "images/kill-job.png")
        ARCGUI_CLEAN_JOB_BUTTON = os.path.join(self.__applicationDir, "images/edit-delete.png")
        ARCGUI_REMOVE_DOWNLOADED_JOB_IMAGE = os.path.join(self.__applicationDir, "images/edit-delete.png")
        ARCGUI_OPEN_URL = os.path.join(self.__applicationDir, "images/open-results.png")
        ...
        self.activeJobList = wx.ListCtrl(self.activeJobsPane, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
        ...
        self.downloadedJobList = wx.ListCtrl(self.downloadedJobsPane, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
        self.noteBook_pane_4 = wx.Panel(self.noteBook, -1)
        self.newDefinitionButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_NEW_DEFINITON_IMAGE,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.editDefinitionButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_EDIT_DEFINITON_IMAGE,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.submitDefinitionButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_SUBMIT_DEFINITION_IMAGE,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.openResultsButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_OPEN_RESULTS_IMAGE,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.deleteDefinitionButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_DELETE_DEFINITION_IMAGE,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.viewDescriptionButton_copy = wx.BitmapButton(self.noteBook_pane_4, -1, wx.Bitmap(ARCGUI_VIEW_DESCRIPTION,wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        ...
        self.Bind(wx.EVT_BUTTON, self.onNewJobDefinition, self.newDefinitionButton_copy)
        self.Bind(wx.EVT_BUTTON, self.onOpenJobDefinition, self.editDefinitionButton_copy)
        self.Bind(wx.EVT_BUTTON, self.onSubmitJobDefinition, self.submitDefinitionButton_copy)
        self.Bind(wx.EVT_BUTTON, self.onViewOutputFiles, self.openResultsButton_copy)
        self.Bind(wx.EVT_BUTTON, self.onDeleteJobDefinition, self.deleteDefinitionButton_copy)
        self.Bind(wx.EVT_BUTTON, self.onShowXrslDescription, self.viewDescriptionButton_copy)
    ...
    def __set_properties(self):
        ...
        self.cleanDownloadedJobButton.SetToolTipString("Refresh status")
        self.cleanDownloadedJobButton.SetSize(self.cleanDownloadedJobButton.GetBestSize())
        self.newDefinitionButton_copy.SetToolTipString("New job definition")
        self.newDefinitionButton_copy.SetSize(self.newDefinitionButton_copy.GetBestSize())
        self.editDefinitionButton_copy.SetToolTipString("Edit job definition")
        self.editDefinitionButton_copy.SetSize(self.editDefinitionButton_copy.GetBestSize())
        self.submitDefinitionButton_copy.SetToolTipString("Submit job definition")
        self.submitDefinitionButton_copy.SetSize(self.submitDefinitionButton_copy.GetBestSize())
        self.openResultsButton_copy.SetToolTipString("View files")
        self.openResultsButton_copy.SetSize(self.openResultsButton_copy.GetBestSize())
        self.deleteDefinitionButton_copy.SetToolTipString("Delete job definition")
        self.deleteDefinitionButton_copy.SetSize(self.deleteDefinitionButton_copy.GetBestSize())
        self.viewDescriptionButton_copy.SetToolTipString("Preview XRSL")
        self.viewDescriptionButton_copy.SetSize(self.viewDescriptionButton_copy.GetBestSize())
    ...
    def __do_layout(self):
        ...
        sizer_9_copy_copy_copy = wx.BoxSizer(wx.HORIZONTAL)
        ...
        sizer_9_copy_copy_copy.Add(self.newDefinitionButton_copy, 0, 0, 0)
        sizer_9_copy_copy_copy.Add(self.editDefinitionButton_copy, 0, 0, 0)
        sizer_9_copy_copy_copy.Add(self.submitDefinitionButton_copy, 0, 0, 0)
        sizer_9_copy_copy_copy.Add(self.openResultsButton_copy, 0, 0, 0)
        sizer_9_copy_copy_copy.Add(self.deleteDefinitionButton_copy, 0, 0, 0)
        sizer_9_copy_copy_copy.Add(self.viewDescriptionButton_copy, 0, 0, 0)
        sizer_3_copy_copy_copy.Add(sizer_9_copy_copy_copy, 0, wx.ALL, 3)
        sizer_33.Add(self.label_3, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_33.Add(self.text_ctrl_1, 1, wx.RIGHT|wx.EXPAND, 4)
        sizer_33.Add(self.bitmap_button_1, 0, 0, 0)
    ...
    def __updateGrid(self):
        ...
        self.activeJobList.SetColumnWidth(0, -1)
        self.activeJobList.SetColumnWidth(1, -2)
        self.activeJobList.SetColumnWidth(2, -1)
        self.activeJobList.SetColumnWidth(3, -2)
    ...
    def __setupDefinitionList(self):
        ...
        if os.environ.has_key("ARCGUI_LOCATION"):
            ...
            arcGuiImagePath = os.path.join(arcGuiLocation, "images")
            
            bitmapFilename = os.path.join(arcGuiImagePath, "generic-definition.png")
        ...
        if len(self.__selectedJobDefinition)!=0:
            ...
            for job, jobInfo in zip(jobList, jobInfoList):
                ...
                if not os.path.exists(taskResultDir):
                    print "taskResultDir = ", taskResultDir
    ...
    def __updateDownloadList(self):
        ...
        self.downloadedJobList.SetColumnWidth(0, -1)
        self.downloadedJobList.SetColumnWidth(1, -2)
        self.downloadedJobList.SetColumnWidth(2, -1)
    ...
    def onRetrieve(self, event): # wxGlade: ArcWindow.<event_handler>
        ...
        if len(self.__selectedActiveJobs)>0:
            ...
            if not self.__retrieveJobsThread.isAlive():
                self.__retrieveJobsThread = RetrieveJobsThread(self, self.__arcClient, jobIds, downloadDir)
                self.__retrieveJobsThread.logger = self.logger
                self.__retrieveJobsThread.start()
                self.startProgress()
            else:
                wx.MessageBox("Job download already in progress. Please try again later.")
    ...
    def onActiveJobListActivated(self, event): # wxGlade: ArcWindow.<event_handler>
        ...
        """
        self.logInfoMsg("Event handler `onActiveJobListActivated' not implemented")
        event.Skip()
